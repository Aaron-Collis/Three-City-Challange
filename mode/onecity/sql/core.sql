...
VALUES  								('THE_EDUCATOR_LEVEL_0',			0,						NULL),
										('THE_EDUCATOR_LEVEL_1',			0,						NULL),
										('THE_EDUCATOR_LEVEL_2',			0,						'ERA_MEDIEVAL'),
										('THE_EDUCATOR_LEVEL_3',			0,						'ERA_INDUSTRIAL');
...
VALUES  								('THE_CARDINAL_LEVEL_0',			0,						NULL),
										('THE_CARDINAL_LEVEL_1',			0,						NULL),
										('THE_CARDINAL_LEVEL_2',			0,						'ERA_MEDIEVAL'),
										('THE_CARDINAL_LEVEL_3',			0,						'ERA_INDUSTRIAL');
...
VALUES  								('THE_BUILDER_LEVEL_0',			0,						NULL),
										('THE_BUILDER_LEVEL_1',			0,						NULL),
										('THE_BUILDER_LEVEL_2',			0,						'ERA_MEDIEVAL'),
										('THE_BUILDER_LEVEL_3',			0,						'ERA_INDUSTRIAL');
...
VALUES  								('THE_RESOURCE_MANAGER_LEVEL_0',			0,						NULL),
										('THE_RESOURCE_MANAGER_LEVEL_1',			0,						NULL),
										('THE_RESOURCE_MANAGER_LEVEL_2',			0,						'ERA_MEDIEVAL'),
										('THE_RESOURCE_MANAGER_LEVEL_3',			0,						'ERA_INDUSTRIAL');
